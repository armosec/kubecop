...
kubectl apply -f etc/app-profile.crd.yaml || error_exit "Failed to apply app profile CRD."
helm install kubecop chart/kubecop -f resources/system-tests/kubecop-values.yaml \
